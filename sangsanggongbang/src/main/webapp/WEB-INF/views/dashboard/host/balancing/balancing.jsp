				...
				<div class="row mb-5">
					<div class="col-12 mb-4">
						...
						<input type="hidden" name="bFlag" value="">
							...
							<!-- 미정산금액 -->
							<c:set var="sumFlagNmonthPrice" value="0" />
							<!-- 당월 미정산 금액 -->
							<c:set var="classCountN" value="0" />
							<!-- 미정산 건수 -->
							<c:set var="classCountY" value="0" />
							<!-- 정산 건수 -->
							<c:set var="classCountMonthN" value="0" />
							<!-- 당월 미정산 건수 -->
							<c:set var="classCountMonthY" value="0" />
							<!-- 당월 정산 건수 -->
							...
							<c:forEach var="vo" items="${list }">
								...
								<c:if test="${vo.bFlag == 'N' }">
									...
									<fmt:parseDate var="chkbReqDate" value="${vo.bReqDate}"
										pattern="yyyy-MM-dd" />
									<c:set var="bReqMonth">
										<fmt:formatDate value="${chkbReqDate}" pattern="MM" />
									</c:set>

									<c:if test="${sysMonth == bReqMonth}">
										<c:set var="sumFlagNmonthPrice"
											value="${sumFlagNmonthPrice+sumN }" />
								...
								<c:if test="${vo.bFlag == 'Y' }">
									...
									<c:if test="${sysMonth == bReqMonth}">
										<c:set var="sumFlagYmonthPrice"
											value="${sumFlagYmonthPrice+sumY }" />
													...
													<div class="card border-light">
														<div
															...
															class="fas fa-angle-down text-success"></span> -->
																	<span class="text-success font-weight-bold">미정산
																		포함 / 수수료 10%제외</span>
																</div>
															</div>
														</div>
												...
												<div class="col-12 col-sm-6 mb-4">
													<div class="card border-light">
														<div
															...
															<div>
																<span class="d-block h6 font-weight-normal">${sysMonth}월
																	정산총액 </span>
																<h5 class="h3 font-weight-bold mb-1">
																	<fmt:formatNumber
												...
												<div class="col-12 col-sm-6 mb-4">
													<div class="card border-light">
														<div
															...
															<div>
																<span class="d-block h6 font-weight-normal">총
																	미정산금액 </span>
																<h5 class="h3 font-weight-bold mb-1">
																	<fmt:formatNumber
																		value="${sumFlagNPrice-sumFlagNPrice*0.1 }"
																		pattern="###,###,###" />
																	원
																</h5>
																<div class="small mt-2">
																	<span class="text-success font-weight-bold">수수료
																		10%제외</span>
																</div>
															</div>
														</div>
													...
													<div class="card border-light">
														<div
															...
															<div>
																...
																<h5 class="h3 font-weight-bold mb-1">
																	<fmt:formatNumber
																		value="${sumFlagNmonthPrice-sumFlagNmonthPrice*0.1 }"
																		pattern="###,###,###" />
																	원
																</h5>
																<div class="small mt-2">
													...
													<div class="card border-light">
														<div
															...
															<div>
																...
																<h5 class="h3 font-weight-bold mb-1">
																	<fmt:formatNumber
																		value="${sumFlagYPrice-sumFlagYPrice*0.1 }"
																		pattern="###,###,###" />
																	원
																</h5>
																<div class="small mt-2">
													...
													<div class="card border-light">
														<div
															...
															<div>
																...
																<h5 class="h3 font-weight-bold mb-1">
																	<fmt:formatNumber
																		value="${sumFlagYmonthPrice-sumFlagYmonthPrice*0.1}"
																		pattern="###,###,###" />
																	원
																</h5>
																<div class="small mt-2">
