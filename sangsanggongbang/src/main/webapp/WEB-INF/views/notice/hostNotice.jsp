				...
				<div class="col-12 col-md-12 col-lg-12 mb-4 mb-lg-5" id="noticeMain"
					...
					<c:if test="${!empty list }">
						<c:forEach var="list" items="${list }">
							<div class="card bg-white border-light p-3 rounded" style="max-Width: 100%;">
								<a
								...
								<div class="card-body p-0 pt-4">
									...
									<div class="d-flex align-items-center my-4" style="float:right;">
										<img class="avatar avatar-sm rounded-circle"
											src="<c:url value='/resources/assets/img/team/profile-picture-2.jpg'/>"
											alt="">
										<h3 class="h6 small ml-2 mb-0" style="text-align: right">
									...
									<p class="mb-0" style="clear:both;">${fn:substring(list.noticeContent,0,150) }...</p>
								</c:if>
									<c:if test="${fn:length(list.noticeContent)<=150 }">
										<p class="mb-0" style="clear:both;">${list.noticeContent }</p>
									</c:if>
								</div>
							</div>
							<br>
