...
<div class="container">
	<div class="row">
		...
		<div class="col-12 col-xl-4 mb-5 mb-xl-0">
			...
			<p class="text-muted font-small mt-2">It's easy. Just select your
				device.</p>
			<a href="#" class="btn btn-sm btn-white mb-xl-0 mr-2"> <span
				...
				class="icon icon-brand mr-2"><span class="fab fa-google-play"></span></span>
				<span class="d-inline-block text-left"> <small
					class="font-weight-normal d-block">Available on</small> Google Play
			</span>
			</a>
		</div>
	</div>
		...
		<div class="col mb-md-0">
			...
			<div id="sa-up-za">
				<p style="text-align: center;">
					(주)상상공방 | 사업자등록번호 : 202-11-21300 | 대표 : 강지니<br> 통신판매업 : 신고번호 제
					2021-서울강남-2022호<br>서울특별시 서초구 서초대로 309 장안빌딩 4층
				</p>
			</div>
			<div
