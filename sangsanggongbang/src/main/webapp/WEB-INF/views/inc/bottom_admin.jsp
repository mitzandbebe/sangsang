...
<footer class="footer py-6 bg-primary text-white">
	...
	<!-- <div class="container">
		<div class="customer_service">
			<div class="row">
				<P><a target="_blank" href="https://themesberg.com/blog">늘솜 신청하기 |</a></p>
				&nbsp;
				<P><a target="_blank" href="https://themesberg.com/blog">이용약관 | </a></p>
				&nbsp;
				<P><a target="_blank" href="https://themesberg.com/blog">개인정보처리방침</a></p>
				&nbsp;
			</div>
			...
			<div class="container">
				<div class="row">
					<p><h3>고객센터</h3></p><br>
						<p>이메일 : suzie_97@naver.com</p><br>
						<p>고객센터 : 070-3673-0143<br></p><br>
						<p>업무시간 : 평일 09:30-18:30(점심: 13:30-14:30)<br></p><br>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-xl-3 mb-3 mb-xl-0">
				...
				<p>
					常想工房<br>One Day Class Matching Site
				</p>
			</div>
			<div class="col-6 col-xl-2 mb-5 mb-xl-0">
				...
				<ul class="footer-links mt-2">
					...
					<li><a target="_blank" href="<c:url value='/host/hostInfo'/>">늘솜
							지원하기</a></li>
					<li><a target="_blank"
						href="<c:url value='/login/login'/> ">호스트로그인</a></li>
					<li><a target="_blank"
		...
		<div class="row">
			<div class="col mb-md-0">
				<a target="_blank" class="d-flex justify-content-center"> <img
					src="${pageContext.request.contextPath }/resources/assets/img/brand/admin_bottom_cpr.png"
					height="25" class="mb-3" alt="Themesberg Logo">
				</a>
				<div id="sa-up-za">
					<p style="text-align: center;">
						(주)상상공방 | 사업자등록번호 : 202-11-21300 | 대표 : 강지니<br> 통신판매업 : 신고번호
						제 2021-서울강남-2022호<br>서울특별시 서초구 서초대로 309 장안빌딩 4층
					</p>
				</div>
				<div
