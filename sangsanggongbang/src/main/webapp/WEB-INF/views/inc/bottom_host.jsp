    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-3 mb-3 mb-xl-0">
                <img src="${pageContext.request.contextPath }/resources/assets/img/brand/host_bottom.png" height="30" class="mb-3" alt="Spaces logo">
            ...
            <div class="col-6 col-xl-3 mb-5 mb-xl-0">
                ...
                <ul class="footer-links mt-2">
                    <li><a href="https://themesberg.com/docs/spaces/getting-started/overview/">공지사항 <span class="badge badge-sm badge-secondary ml-2">new</span></a></li>
        ...
        <div class="row">
            <div class="col mb-md-0">
                <a target="_blank" class="d-flex justify-content-center">
                    <img src="${pageContext.request.contextPath }/resources/assets/img/brand/host_bottom_cpr.png" height="25" class="mb-3" alt="Themesberg Logo">
                </a>
                <div id="sa-up-za" >
