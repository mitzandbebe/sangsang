                                ...
                                <div class="card card-body bg-white border-light mb-4">
                                    <h2 class="h5 mb-4">내 정보 조회</h2>
								        ...
								        <div style="float: left; margin-left: 30px; margin-top:30px; " >
										  ...
										  <div class="col-md-8 mb-3" style = "float: left; margin-left: 50px; margin-top:30px;" >
                                                <div class="form-group">
                                                    <div class="input-group mb-4">
			                                            <div class="input-group-prepend">
			                                                <span class="input-group-text"><i class="fas fa-id-card"></i>&nbsp;&nbsp;&nbsp;&nbsp;이름</span>
			                                            </div>
                                           				<input name ="mName" class="form-control" id="mName" readonly="readonly" type="text" value="${vo.hName}" >
                                            		</div>
                                                </div>
                                            </div>
                                            <div class="col-md-8 mb-3" style = "float: left; margin-left: 50px;">
                                                <div class="form-group">
                                                    <div class="input-group mb-4">
			                                            <div class="input-group-prepend">
			                                                <span class="input-group-text"><i class="far fa-smile"></i>&nbsp;&nbsp;닉네임</span>
			                                            </div>
                                           				<input name ="mNickname" class="form-control" id="mNickname" readonly="readonly" type="text" value="${vo.hNickname}">
                                            		</div>
                                                </div>
                                            </div>
								       </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group mb-4">
			                                            <div class="input-group-prepend">
	                                           	 		...
	                                           	 		<input name ="phone" class="form-control" id="phone" readonly="readonly" maxlength="11" type="text" value="${vo.hPhone}">
                                            		</div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    <div class="input-group mb-4">
			                                            <div class="input-group-prepend">
	                                           			 ...
	                                           			 <input name ="bday" class="form-control" id="bday" maxlength="6" readonly="readonly" type="text" value="${vo.hBday}">
                                            		</div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                     <div class="input-group mb-4">
			                                            <div class="input-group-prepend">
			                                           	...
			                                           	<input name ="mZipcode" class="form-control" id="zipcode" readonly="readonly" type="text" value="${vo.hZipcode}">
                                                ...
                                                <div class="form-group">
                                                     <div class="input-group mb-4">
			                                            <div class="input-group-prepend">
                                           			  ...
                                           			  <input name ="mAddress" class="form-control" id="address" readonly="readonly" type="text" value="${vo.hAddress}">
                                            		</div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- Form -->
                                   	<div class="input-group mb-4">
                                		<div class="input-group-prepend">
                                       	...
                                       	<input name ="mAddressDetail" class="form-control" id="mAddressDetail"  readonly="readonly" type="text" value="${vo.hAddressDetail}">
                                    </div>
                                    <!-- End of Form -->
                                   </div>
                              </div>
