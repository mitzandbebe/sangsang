			...
			<c:if test="${!empty list }">
				...
				<c:forEach var="vo" items="${list }">
					<tr>
						...
						<td>
						<a href="<c:url value='/recommendation/recommendDetail?recoNo=${vo.recoNo}'/>">
			...
			<div
				...
				<div>
					...
					<c:if test="${pagingInfo.firstPage>1 }">
							<li class="page-item">
					<a class="page-link" href="<c:url value='/recommendation/recommendlist?currentPage=${pagingInfo.firstPage -1 }'/> ">
					<i
